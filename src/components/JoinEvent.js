    ...
    return (
      <div className="JoinEvent">
        <div className="contents-top" ref={ref => (this.topDoor = ref)}>
          <img
            src="/imgs/joinevent/contents-top.png"
            alt="이벤트 계좌로 1원 보내봐!"
          />
          <Link className="close-btn" to="/">
            <img
              src="/imgs/joinevent/closebutton.png"
        ...
        <div className="contents-bottom" ref={ref => (this.bottomDoor = ref)}>
          <img
            src="/imgs/joinevent/contents-bottom.png"
        ...
        <div className="main-btn">
          <Link to="/">
            <img src="/imgs/joinevent/mainbutton.png" alt="송금하기" />
          </Link>
        </div>
      </div>
    );
